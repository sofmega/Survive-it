...
@onready var arrow_tower_button: Button = $UI/BuildPanel/MarginContainer/VBoxContainer/ArrowTowerButton
@onready var slow_beacon_button: Button = $UI/BuildPanel/MarginContainer/VBoxContainer/SlowBeaconButton
@onready var repair_post_button: Button = $UI/BuildPanel/MarginContainer/VBoxContainer/RepairPostButton
@onready var command_banner_button: Button = $UI/BuildPanel/MarginContainer/VBoxContainer/CommandBannerButton
@onready var repair_fortress_button: Button = $UI/BuildPanel/MarginContainer/VBoxContainer/RepairFortressButton
@onready var upgrade_fortress_button: Button = $UI/BuildPanel/MarginContainer/VBoxContainer/UpgradeFortressButton
@onready var build_cost_label: Label = $UI/BuildPanel/MarginContainer/VBoxContainer/CostLabel
